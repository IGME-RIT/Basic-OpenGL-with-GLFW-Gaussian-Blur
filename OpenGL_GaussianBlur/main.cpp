...
int main(int argc, char **argv)
{
	...
	// Initialize window
	GLFWwindow* window = glfwCreateWindow(viewportDimensions.x, viewportDimensions.y, "I need new glasses", nullptr, nullptr);
    ...
    fullscreenVert.InitFromFile("../Assets/fullscreenVert.glsl", GL_VERTEX_SHADER);
    invertFrag.InitFromFile("../Assets/gaussianFrag.glsl", GL_FRAGMENT_SHADER);
